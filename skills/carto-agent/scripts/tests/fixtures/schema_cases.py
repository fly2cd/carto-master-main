...
VALID_CASES = {
    ...
    "knowledge-evidence": {"schema_version": 1, "evidence_id": "evidence-one", "claim": "风险等级字段单位为百分比", "source": P, "applicability": {"jurisdiction": "示例地区", "valid_from": "2026-01-01", "industry": "emergency"}, "digest": D},
